        ...
        <div className="faq-wrapper">
          <div className="faq-container">
            ...
            <p className="info-tip">
             ...
             is a high-speed, comprehensive decentralised trading platform for digital assets and is the only existing exchange where traders can execute large orders at low cost directly from their privately owned wallets. With no sign-up or registration needed, DeversiFi supports all of the most popular wallet choices such as Metamask, Squarelink, Ledger, Trezor. Incubated over a 2 year period by Ethfinex under the trustless.ethfinex banner, DeversiFi is now a fully independent exchange that meets the needs of professional traders, without compromising on speed, security or choice and will be the first-to-market exchange to be powered by StarkWare technology, bringing instant settlement, deep liquidity, enhanced security and competitive fees to non-custodial trading.
            </p>
          </div>
          <div className="faq-container">
          <h2>What is Nectar.Community?</h2>
            <p className="info-tip">
              ...
              <a href="https://github.com/ethfinex/community-gateway" target="_blank">
               ...
               As well as functionality for submitting proposals and voting, the site also provides statistics, learning resources, and tools such as the trader leaderboard to allow Nectar token holders to be a part of the necDAO ecosystem as well as being involved in the NEC burn event auctions and promote the use of DeversiFi and a comprehensive and feature rich platform.
          </p>
          </div>
          <div className="faq-container">
            <h2>What is the Nectar token (NEC)?</h2>
            <p className="info-tip">
              The Nectar token is a deflationary governance and utility token created originally by Ethfinex as part of its journey towards decentralisation, and now underpinning DeversiFi’s continuation of that journey. The function of the token is to help grow the world’s largest exchange member base. Today the token, incentivises holders with fee discounts on DeversiFi, and empowers them, as necDAO members, to participate in the collective decision making and direction of Nectar and DeversiFi. Furthermore, every week, up to 50% of the revenues from DeversiFi trading fees will be used in an auction type NEC “buy and burn” event, thus reducing the supply over time. To find out more information about the Nectar token please read the {' '} 
          ...
          <div className="faq-container">
            ...
            <p className="info-tip">
              ...
              <a href="https://www.bitfinex.com/" target="_blank">
                Bitfinex </a>{' '}
              against USD, ETH and BTC. This list will continue to grow as the implementation and usage of Nectar increases, and following the removal of a KYC whitelist, which now opens the token up to the wider DeFi ecosystem.
            </p>
          </div>
        </div>
