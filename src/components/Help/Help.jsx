        ...
        </div>
        {
          ...
          <div className="help-wrapper">
            <div className="help-inner-wrapper">
              ...
              <p><strong>Already have EVT?</strong></p>

                <li><a href="https://support.ethfinex.com/hc/en-us/articles/115002246152-Making-a-Withdrawal" target="_blank">Withdraw</a> or transfer your EVT to the external Ethereum wallet (Ledger, MetaMask or Keystore).</li>
                <li>Visit Nectar.community and find Token Listings in the menu (this page);</li>
                <li>Connect your wallet. We advise all users to access the site via MetaMask or Ledger;</li>
                <li>Ensure your wallet contains ETH, alongside EVT, for transaction gas fees;</li>
                <li>Vote for your preferred token. Please note that your entire EVT balance will be cast when voting. To vote for multiple tokens repeat the process, depositing precise amounts of EVT each time.</li>
              </ol>
              </div>
              <div className="video-wrapper">
                <iframe width="100%" height="300" src="https://www.youtube.com/embed/IBbbnPrPt-g" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>
              <p>To learn more, please visit the <a href="/faq">Nectar.community FAQ</a> or get in touch with us on <a href="https://t.me/ethfinextelegram" target="_blank">Telegram</a>.</p>
