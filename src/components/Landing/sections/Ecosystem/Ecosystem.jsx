  ...
  return (
    <section className="landing__section">
      <p className="landing__section-content">
        Nectar exists as a token on the Ethereum blockchain, allowing it to interact with the
        wider Decentralised Finance ecosystem, and is listed on multiple exchanges
        to promote discovery and liquidity.
      </p>
