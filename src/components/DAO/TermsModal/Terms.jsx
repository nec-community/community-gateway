    ...
    <div>
      ...
      <ol>
        <li><strong>THE PARTIES</strong>
          <ol>
            <li>Parties to this Agreement are:
              <ol>
                <li>Liquidity Labs Holdings Limited</li>
            ...
            <li>
              ...
              regulating the exercise of their rights and obligations in relation to
              the Reputation Bootstrap Period and/or the Governance Period
